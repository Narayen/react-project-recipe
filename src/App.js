...
class App extends Component {
  state = {
    recipes: recipes,
    url: "https://www.food2fork.com/api/search?key=9fc9745b9707effb6fd37ac8e54de601",
    base_url: "https://www.food2fork.com/api/search?key=9fc9745b9707effb6fd37ac8e54de601",
    details_id: 35384,
    pageIndex: 1,
    search: "",
    query: '&q=',
  ...
  async getRecipes() {
    try {
      ...
      if (jsonData.recipes.length === 0) {
        this.setState(() => {
          return { error: 'Sorry, your search did not bring any results....'}
        })
      } else {
        this.setState(() => {
