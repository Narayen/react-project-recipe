...
export default class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url: `https://www.food2fork.com/api/get?key=9fc9745b9707effb6fd37ac8e54de601&rId=${this.props.id}` };
    // }
    ...
    async componentDidMount(){
        ...
        const url = `https://www.food2fork.com/api/get?key=9fc9745b9707effb6fd37ac8e54de601&rId=${id}`;
            try {
